	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form method ="POST" class="login100-form validate-form" action="index.php?act=quenmatkhau" >
					<span class="login100-form-title">
						Quên mật khẩu
					</span>


					<div class="wrap-input100 validate-input" data-validate = " Email không được trống">
						<input class="input100" type="email" name="forgotemail" placeholder="Email">
					...
					<div class="wrap-input100 validate-input" data-validate = "Phone không được trống">
						<input class="input100" type="text" name="forgotphone" placeholder="phone">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-lock" aria-hidden="true"></i>
						</span>

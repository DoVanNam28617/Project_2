          ...
          <div class="tile-body">
            ...
            <div class="row element-button">
              <div class="col-sm-2">
                ...
                <a class="btn btn-add btn-sm" href="index.php?act=addkh" title="Thêm"><i class="fas fa-plus"></i>
                  Tạo mới nhân viên</a>
              </div>
              <div class="col-sm-2">
            ...
            <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
              id="sampleTable">
                ...
                <tr>
                  ...
                  <th style="text-align: center;width:100px">ID nhân viên</th>
                  ...
                  <th width="100" style="text-align: center">Tính năng</th>
                </tr>
            
                <?php foreach( $listtaikhoan as $khachhang){
                   extract($khachhang);
                   $suadm = " index.php?act=suakh&id_kh=".$id_kh;
                   $xoadm = "index.php?act=xoakh&id_kh=".$id_kh;               
                   if($vai_tro==10){
                     $vaiTro = "<b style='color:red'>Admin</b>";
                   }else{
                    $vaiTro = "Khách hàng";
                   }
                    ...
                    <td>MHKT - '.$id_kh.'</td>
                    <td>'.$ho_ten.'</td>
                    <td style="width:90px">'.$mat_khau.'</td>
                    <td>'.$email.'</td>
                    <td>'.$vaiTro.'</td>
                    <td class="table-td-center"  style="text-align: center;">  <a onclick="return confirm("Bạn có chắc muốn xóa không?")" href="'.$xoadm.'"><button class="btn btn-primary btn-sm trash" type="button" title="Xóa"

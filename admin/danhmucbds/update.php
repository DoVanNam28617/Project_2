          ...
          <div class="tile-body">
            ...
            <form class="row" action="index.php?act=updatedm" method="POST" enctype="multipart/form-data">
              <div class="form-group col-md-3">
                ...
                <input name="id_loai" class="form-control" type="text" value="<?= $id_loai ?>" disabled>
              </div>
              <div class="form-group col-md-3">
                <label class="control-label">Tên loại</label>
                <input name="ten_loai" class="form-control" type="text" value="<?= $ten_loai ?>">
              ...
              <div class="form-group col-md-3" hidden>
                <label class="control-label">Mã loại</label>
                <input name="id_loai" class="form-control" type="text" value="<?= $id_loai ?>" >
              </div>

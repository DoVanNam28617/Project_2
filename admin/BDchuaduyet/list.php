    ...
    <main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb side">
                <li class="breadcrumb-item active"><a href="#"><b>Danh sách bài đăng không duyệt</b></a></li>
            </ul>
            <div id="clock"></div>
        </div>
        <div class="row">
                        ...
                        <table class="table table-hover table-bordered" id="sampleTable">
                            <thead>
                                <tr >
                                    ...
                                    <th style="text-align: center">Lí do không duyệt</th>
                                    <th style="text-align: center">Chức năng</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                  foreach($list_BDloi as $list_BDloi)
                                  {
                                    extract($list_BDloi);
                                    // $phe_duyet = "index.php?act=pheduyetsp&id=$id";
                                    $xoasp = "index.php?act=xoabdchuaduyet&id=".$id;
                                    // $huy = "index.php?act=nd_duyet&id=".$id;
                                    ...
                                    <td class="mo_ta" style="width:320px">'.$mo_ta.' </td>
                                    <td class="mo_ta" style="width:320px">'.$li_do.' </td>

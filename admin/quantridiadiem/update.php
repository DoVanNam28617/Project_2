...
<body class="app sidebar-mini rtl">
  ...
  <main class="app-content">
    <div class="app-title">
      ...
      <li class="breadcrumb-item"><a href="index.php?act=listdiadiem">Danh sách danh mục</a></li>
      </ul>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          ...
          <div class="tile-body">
            ...
            <form class="row" action="index.php?act=updatedd" method="POST" enctype="multipart/form-data">
              <div class="form-group col-md-3">
                <label class="control-label">Mã địa điểm</label>
                <input name="id_dd" class="form-control" type="text" value="<?= $id_dd ?>" disabled>
              </div>
              <div class="form-group col-md-3">
                <label class="control-label">Tên địa điểm</label>
                <input name="ten_dd" class="form-control" type="text" value="<?= $ten_dd ?>">
              ...
              <div class="form-group col-md-3" hidden>
                ...
                <input name="id_dd" class="form-control" type="text" value="<?= $id_dd ?>" >
              </div>

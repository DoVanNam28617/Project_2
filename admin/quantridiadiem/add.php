...
<main class="app-content">
    <div class="app-title">
      <ul class="app-breadcrumb breadcrumb">
        <li class="breadcrumb-item"><a href="index.php?act=listdiadiem">Danh sách địa điểm</a></li>
      </ul>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          <h3 class="tile-title">Thêm mới địa điểm</h3>
          <div class="tile-body">
            <div class="row element-button">
            </div>
            <form class="row" action="index.php?act=adddd" method="POST" >
              <div class="form-group col-md-3">
                <label class="control-label">Mã địa điểm</label>
                <input name="madd" class="form-control" type="text" disabled>
              </div>
              <div class="form-group col-md-3">
                <label class="control-label">Tên địa điểm</label>
                <input name="tendd" class="form-control" type="text">
                <span style="color:red">
                    <?=isset($error['tendd']) ? $error['tendd'] : '' ?>
                </span>
              </div>
